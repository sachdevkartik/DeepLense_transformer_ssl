...
_C.DATA.BATCH_SIZE = 64
_C.DATA.DATA_PATH = os.path.join(os.environ["HOME"], "Transformer-SSL/data")
_C.DATA.ZIP_MODE = False
...
_C.AMP_OPT_LEVEL = "00"
_C.OUTPUT = os.path.join(os.environ["HOME"], "Transformer-SSL/output")
_C.TAG = "DeepLense"
_C.EVAL_MODE = False
_C.THROUGHPUT_MODE = False
_C.LOCAL_RANK = 0
_C.OUTPUT = os.path.join(_C.OUTPUT, _C.MODEL.NAME, _C.TAG)
