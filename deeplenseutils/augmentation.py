...
def get_transform_train_sl(upsample_size: int, final_size: int, channels: Optional[int] = 1):
...
def get_transform_test_sl(final_size: int, channels: Optional[int] = 1):
    ...
    transform_effective = A.Compose([A.Resize(final_size, final_size, p=1.0), ToTensorV2()])
